...
class Curso(models.Model):
    ...
    area_cod = models.ForeignKey(Area, "Cod Area", on_delete=models.CASCADE)
...
class Disciplina(models.Model):
    ...
    curso_cod = models.ForeignKey(Curso, "Cod Curso", on_delete=models.CASCADE)
    area_cod = models.ForeignKey(Area, "Cod Area", on_delete=models.CASCADE)
...
class Assunto(models.Model):
    ...
    disciplina_cod = models.ForeignKey(Disciplina, "Cod Disciplina", on_delete=models.CASCADE)
    curso_cod = models.ForeignKey(Curso, "Cod Curso", on_delete=models.CASCADE)
    area_cod = models.ForeignKey(Area, "Cod Area", on_delete=models.CASCADE)
...
class TetaUsuario(models.Model):
    ...
    disciplina_cod = models.ForeignKey(Disciplina, "Cod Disciplina", on_delete=models.CASCADE)
    assunto_cod = models.ForeignKey(Assunto, "Cod Assunto", on_delete=models.CASCADE)
...
class QuestaoAlternativa(models.Model):
    ...
    questao_cod = models.OneToOneField(Questao, "Cod Questao", on_delete=models.CASCADE)
